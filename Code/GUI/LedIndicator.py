...
class NewLedIndicator(QAbstractButton):
    scaledSize = 200.0
    ...
    def paintEvent(self, QPaintEvent):
        ...
        gradient = QRadialGradient(QPointF(-300, -300), 900, QPointF(-300, -300))
        gradient.setColorAt(0, QColor(224, 224, 224))
        gradient.setColorAt(1, QColor(28, 28, 28))
        painter.setPen(pen)
        painter.setBrush(QBrush(gradient))
...
class CANLedIndicator(QAbstractButton):
    scaledSize = 200.0
    ...
    def __init__(self, parent=None):
        ...
        self.off_color_2 = QColor(255,0,0)
